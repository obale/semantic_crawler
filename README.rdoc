...
You can add this library also as dependency in your Gemfile:
    ...
    gem "semantic_crawler", :git => "git://github.com/obale/semantic_crawler.git"                   # for the master branch or
    gem "semantic_crawler", :git => "git://github.com/obale/semantic_crawler.git", :tags => "xyz"   # for the xyz tag


== Examples

Fetch Freebase information about Austria:

    >> freebaseCrawler = SemanticCrawler::Freebase::Crawler.new
    >> austria = freebaseCrawler.getCountry("Austria")
    >> austria.get

Fetch Freebase information about Germany:

    >> freebaseCrawler = SemanticCrawler::Freebase::Crawler.new
    >> germany = freebaseCrawler.getCountry("Germany")
    >> germany.get


== {Changelog}[link:CHANGELOG.rdoc]

With the first version a CHANGELOG will be introduced.
